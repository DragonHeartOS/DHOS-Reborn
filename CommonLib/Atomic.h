...
template<typename T> struct Atomic {
	...
	/// @brief Compare the value of the atomic variable with an expected value
	/// and exchange it if they match.
	...
	/// fails.
	/// @return True if the comparison succeeded and the exchange was performed,
	/// false otherwise.
	...
	/// @brief Atomically subtract a value from the atomic variable and return
	/// the previous value.
	...
	/// @brief Atomically perform a bitwise OR operation on the atomic variable
	...
	/// @brief Atomically perform a bitwise AND operation on the atomic variable
	/// and return the previous value.
	...
	/// @brief Atomically perform a bitwise XOR operation on the atomic variable
	/// and return the previous value.
